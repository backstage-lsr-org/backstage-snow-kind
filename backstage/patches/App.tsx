...
const serviceNowApiFactory: AnyApiFactory = createApiFactory({
  api: serviceNowApiRef,
  deps: { configApi: configApiRef },
  factory: ({ configApi }) => new ServiceNowAPI({ configApi }),
});

const app = createApp({
  apis: [...apis, serviceNowApiFactory],
  bindRoutes({ bind }) {
